...
class EditKamera extends StatefulWidget {
  const EditKamera({Key? key}) : super(key: key);

  @override
  State<EditKamera> createState() => _EditKameraState();
}

class _EditKameraState extends State<EditKamera> {
